...
class Estimate extends BaseModel
{
    ...
    use Notifiable, CustomFieldsTrait, SoftDeletes;
    ...
    public function getOriginalEstimateNumberAttribute()
    {
        ...
        return $this->attributes['estimate_number'];
    }
    ...
    public function getEstimateNumberAttribute($value)
    {
        ...
        return $invoiceSettings->estimate_number_separator . $zero . $value;
    ...
    public static function lastEstimateProposalNumber($company_id, $estimate_type)
    {
        return (int)Estimate::where('company_id',$company_id)->withTrashed()->max('estimate_number');
       
    }

    public function companyAddress():belongsTo
    {
        return $this->belongsTo(Company::class, 'company_id', 'id')->select('id','company_name','address','city','state','zipcode','country');
    }
    ...
    {
        return $this->belongsTo(HouseService::class, 'house_services_id', 'id');
    }

    public function vatTypes():belongsTo
    {
        return $this->belongsTo(VatTypes::class, 'vat_type_id', 'id');
    }

    public function estimateSection():hasMany
    {
        return $this->hasMany(EstimateSection::class, 'estimate_id');
    }

    public function acceptEstimate():hasOne
    {
        return $this->hasOne(AcceptEstimate::class, 'estimate_id');
    }

    public function clientEmail():hasOne
    {
        return $this->hasOne(EstimateEmail::class, 'estimate_id');
    }
