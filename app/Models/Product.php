...
class Product extends BaseModel
{
    ...
    use HasCompany;
    use HasFactory, CustomFieldsTrait, SoftDeletes;
    ...
    public function taxRate(){
        return $this->belongsTo(Tax::class, 'taxes','id');
    }

    public function taxAccountNumber(){
        return $this->belongsTo(TaxAccountNumber::class, 'account_code','id');
    }
