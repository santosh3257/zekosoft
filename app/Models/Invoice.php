...
class Invoice extends BaseModel
{
    ...
    protected $with = ['currency', 'address','items'];
    ...
    public function invoiceClient(): BelongsTo
    {
    ...
    {
        return (int)Invoice::withTrashed()->max('invoice_number');
    }
    ...
    public function getInvoiceNumberAttribute($value)
    {
        ...
        if (company()) {
            $invoiceSettings = company()->invoiceSetting;
        }
        else {
            $invoiceSettings = $this->company ? $this->company->invoiceSetting : null;
        }
    ...
    {
        return $this->belongsTo(HouseService::class, 'house_service_id','id');
    }
