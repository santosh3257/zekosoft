...
class EstimateItem extends BaseModel
{
    ...
    {
        return $this->belongsTo(HouseWork::class, 'house_work_id','id');
    }

    public function TaxInfo():belongsTo
    {
        return $this->belongsTo(VatPercentage::class, 'tax_id', 'id');
    }
    public function accountCode():belongsTo
    {
        return $this->belongsTo(TaxAccountNumber::class, 'account_code_id', 'id');
    }
