...
class CompanyObserver
{
    ...
    public function roles($company): void
    {
        ...
        $managerRole->company_id = $company->id;
        $managerRole->display_name = 'Manager'; // optional
        $managerRole->description = 'Manager can see own tasks and projects.'; // optional
        $managerRole->saveQuietly();

        $bookkeeperRole = new Role();
        $bookkeeperRole->name = 'bookkeeper';
        $bookkeeperRole->company_id = $company->id;
        $bookkeeperRole->display_name = 'Bookkeeper'; // optional
        $bookkeeperRole->description = 'Bookkeeper can see own tasks and projects.'; // optional
        $bookkeeperRole->saveQuietly();

        $bookkeeperRole = new Role();
        $bookkeeperRole->name = 'contractor';
        $bookkeeperRole->company_id = $company->id;
        $bookkeeperRole->display_name = 'Contractor'; // optional
        $bookkeeperRole->description = 'Contractor can see own tasks and projects.'; // optional
        $bookkeeperRole->saveQuietly();
    ...
    public function updateModuleSettings($company): void
    {
        ...
        ModuleSetting::whereIn('id', $activeModuleSettings)->update(['status' => 'active', 'is_allowed' => 1]);
        ModuleSetting::whereIn('id', $inactiveModuleSettings)->update(['status' => 'deactive', 'is_allowed' => 0]);
