...
use App\Listeners\SignupOtpListener;
use App\Listeners\ForgotPasswordOtpListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        SignupOtpEvent::class => [SignupOtpListener::class],
        ForgotPasswordOtpEvent::class => [ForgotPasswordOtpListener::class],
