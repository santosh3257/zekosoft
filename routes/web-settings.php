...
use App\Http\Controllers\TaxAccountNumberController;
...
Use App\Http\Controllers\HouseServicesController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    // Vat Types
    Route::resource('vat-types', VatTypesController::class);
    Route::get('account-number/update-default-accountCode', [TaxAccountNumberController::class, 'updateDefaultAccountCode']);
    Route::get('account-number/update-default-accountCodeNo', [TaxAccountNumberController::class, 'updateDefaultAccountCodeNo']);
    Route::resource('account-number', TaxAccountNumberController::class);
    // House Services
    Route::resource('house-services', HouseServicesController::class);

    // House Work
    Route::resource('house-works', HouseWorksController::class);
