    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        @if (user()->permission('manage_tax') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="tax_settings" :href="route('taxes.index')"
                                 :text="__('app.menu.vatType')"/>
            
        @endif

        @if(user()->permission('manage_account_number') == 'all')
        <x-setting-menu-item :active="$activeMenu" menu="account_number" :href="route('account-number.index')"
                                 :text="__('app.menu.taxAccountNumber')"/>
        @endif

        @if(user()->permission('house_services') == 'all')
        <x-setting-menu-item :active="$activeMenu" menu="house_services" :href="route('house-services.index')"
                                 :text="__('app.menu.houseServices')"/>

        <x-setting-menu-item :active="$activeMenu" menu="house_works" :href="route('house-works.index')"
                                 :text="__('app.menu.houseWorks')"/>
        @endif
