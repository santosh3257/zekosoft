        ...
        <x-form id="update-package-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row px-3 my-3">
                    ...
                    @if($package->employee_unlimited == 'true')
                        <x-forms.checkbox class="mr-0 mr-lg-2 mr-md-2"
                                          :fieldLabel="__('superadmin.packages.unlimitedClient')"
                                          fieldName="employee_unlimited" fieldId="is_employee_unlimited" :popover="__('superadmin.packages.maxEmployeesInfo')" :checked="$package->employee_unlimited" fieldValue="true"/>
                    @else
                    <x-forms.checkbox class="mr-0 mr-lg-2 mr-md-2"
                                          :fieldLabel="__('superadmin.packages.unlimitedClient')"
                                          fieldName="employee_unlimited" fieldId="is_employee_unlimited" :popover="__('superadmin.packages.maxEmployeesInfo')" fieldValue="true"/>
                    @endif

                    @if($package->employee_unlimited == 'true')
                        <div class="max-emp d-none">
                        <x-forms.number :fieldLabel="__('superadmin.max') . ' ' . __('app.menu.clients')"
                                        fieldName="max_employees" fieldId="max_employees" :fieldValue="$package->max_employees"
                        />
                        </div>
                    @else
                        <div class="max-emp">
                    ...
                    <div class="col-md-6 col-lg-6">
                        @if($package->project_unlimited == 'true')
                        <x-forms.checkbox class="mr-0 mr-lg-2 mr-md-2"
                                          :fieldLabel="__('superadmin.packages.unlimitedProject')"
                                          fieldName="project_unlimited" fieldId="is_project_unlimited" :checked="$package->project_unlimited" fieldValue="true"/>
                        @else
                        <x-forms.checkbox class="mr-0 mr-lg-2 mr-md-2"
                                          :fieldLabel="__('superadmin.packages.unlimitedProject')"
                                          fieldName="project_unlimited" fieldId="is_project_unlimited" fieldValue="true"/>
                        @endif

                        @if($package->project_unlimited == 'true')
                            <div class="max-pro d-none">
                            <x-forms.number :fieldLabel="__('superadmin.max') . ' ' . __('app.menu.projects')"
                                            fieldName="max_project" fieldId="max_project" :fieldValue="$package->max_project"
                            />
                            </div>
                        @else
                            <div class="max-pro">
