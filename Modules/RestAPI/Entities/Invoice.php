...
class Invoice extends \App\Models\Invoice
{
    ...
    public function co_applicant(): HasMany
    {
        return $this->HasMany(TaxReduction::class, 'invoice_id');
    }
    ...
    public static function lastCompanyInvoiceNumber($company_id)
    {
        return (int)Invoice::where('company_id',$company_id)->max('invoice_number');
    }
}
